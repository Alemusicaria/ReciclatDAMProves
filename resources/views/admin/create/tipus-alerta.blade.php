<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12">
            <h4 class="mb-3">{{ __('messages.admin.tipus_alertes.create_title') }}</h4>
            ...
            <div class="modal-body-scroll">
                <form id="createTipusAlertaForm" method="POST" action="{{ route('admin.tipus-alertes.store') }}">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <button type="submit" class="btn btn-primary" id="submitCreateTipusAlertaForm">{{ __('messages.admin.tipus_alertes.save_button') }}</button>
                    </div>
                </form>
            </div>
        </div>
