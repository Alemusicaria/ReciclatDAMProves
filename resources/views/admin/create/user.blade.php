<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12">
            <h4 class="mb-3">{{ __('messages.admin.users.create_title') }}</h4>
            ...
            <div class="modal-body-scroll">
                <form id="createUserForm" method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card mb-3 form-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label for="password" class="form-label">{{ __('messages.admin.users.password') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="ubicacio" name="ubicacio" placeholder="{{ __('messages.admin.users.location_placeholder') }}">
                                </div>
                            </div>
                    ...
                    <div class="card mb-3 form-card">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label for="punts_actuals" class="form-label">{{ __('messages.admin.users.initial_points') }}</label>
                                    <input type="number" class="form-control" id="punts_actuals" name="punts_actuals" value="0" min="0">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <button type="submit" class="btn btn-primary" id="submitCreateUserForm">{{ __('messages.admin.users.save_button') }}</button>
                    </div>
                </form>
            </div>
        </div>
