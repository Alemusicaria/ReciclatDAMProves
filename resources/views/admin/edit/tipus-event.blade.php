<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12">
            <h4 class="mb-3">{{ __('messages.admin.tipus_events.edit_title') }}</h4>
            ...
            <div class="modal-body-scroll">
                <form id="editTipusEventForm" method="POST" action="{{ route('admin.tipus-events.update', $tipusEvent->id) }}">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <button type="submit" class="btn btn-primary" id="updateTipusEventBtn">{{ __('messages.admin.tipus_events.update_button') }}</button>
                    </div>
                </form>
            </div>
        </div>
